    ...
    <AppStateProvider>
      <div className="min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-orange-50 relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-gradient-to-tr from-amber-200/30 to-orange-300/30 rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute top-1/3 left-1/3 w-64 h-64 bg-gradient-to-r from-orange-300/20 to-amber-300/20 rounded-full blur-2xl animate-pulse"></div>
        </div>

        {/* Header */}
        <header className="relative z-10 bg-gradient-to-r from-orange-600 via-orange-500 to-amber-500 shadow-2xl border-b border-white/20 backdrop-blur-sm">
                    ...
                    <div className="relative z-10 flex flex-col items-center space-y-2 sm:space-y-3">
                      <div className={`p-2 sm:p-3 rounded-xl transition-all duration-300 ${
                        isActive 
                          ...
                          : 'bg-orange-100/80 group-hover:bg-orange-200/80 group-hover:shadow-md'
                      }`}>
                        <Icon className={`w-5 h-5 sm:w-6 sm:h-6 ${isActive ? 'text-white' : 'text-orange-600'}`} />
                      </div>
