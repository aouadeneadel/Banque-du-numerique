...
import logo from 'figma:asset/9bb3d3fbc8364562e442d10bd95e8487f135df30.png';
          ...
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Gestion d'inventaire PCs & Smartphones</p>
              </div>
            </div>
