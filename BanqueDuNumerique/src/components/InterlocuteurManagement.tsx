          ...
          <div className="flex justify-between items-center">
            ...
            <Dialog open={isAddDonDialogOpen} onOpenChange={setIsAddDonDialogOpen}>
              ...
              <DialogContent className="max-w-lg">
                <ScrollButtons targetClass="don-modal-scrollable" />
                <DialogHeader>
                ...
                <div className="grid gap-4 py-4 don-modal-scrollable" style={{ maxHeight: '60vh', overflowY: 'auto' }}>
                  <div>
          ...
          <div className="flex justify-between items-center">
            ...
            <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
              ...
              <DialogContent className="max-w-2xl">
                <ScrollButtons targetClass="modal-scrollable" />
                <DialogHeader>
                  <DialogTitle>
                ...
                <div className="grid gap-4 py-4 modal-scrollable" style={{ maxHeight: '60vh', overflowY: 'auto' }}>
...
// Composant ScrollButtons : affiche les boutons si le contenu déborde
function ScrollButtons({ targetClass }: { targetClass: string }) {
  const [show, setShow] = useState(false);
  useEffect(() => {
    const checkScroll = () => {
      const modal = document.querySelector(`.${targetClass}`);
      if (modal) {
        setShow(modal.scrollHeight > modal.clientHeight);
      }
    };
    checkScroll();
  ...
  return (
    <div className="flex justify-end items-center gap-2 mb-2">
      <button
        type="button"
        aria-label="Monter"
        className="p-2 rounded-full bg-orange-100 hover:bg-orange-300 shadow transition-transform duration-200 hover:scale-110"
        onClick={() => {
          const modal = document.querySelector(`.${targetClass}`) as HTMLElement | null;
          if (modal) modal.scrollBy({ top: -200, behavior: 'smooth' });
        }}
      >
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none"><path d="M5 12l5-5 5 5" stroke="#F97316" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
      </button>
      <button
        type="button"
      ...
      >
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none"><path d="M5 8l5 5 5-5" stroke="#F97316" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
      </button>
    </div>
  );
}