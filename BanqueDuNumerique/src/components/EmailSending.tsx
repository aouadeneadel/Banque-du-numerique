...
export function EmailSending() {
  ...
  const handleSendEmail = async () => {
    ...
    setTimeout(() => {
      setIsSending(false);
      toast.success(`Email envoyé avec succès à ${recipient} pour le ${selectedDevice.type === 'PC' ? 'PC' : 'smartphone'} ${selectedDevice.marque} ${selectedDevice.modele}`);
      setRecipient('');
