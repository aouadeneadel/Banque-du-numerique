...
export function Statistics() {
  const [stats, setStats] = useState<StatData>({
    ...
    totalDevices: 20,
    byEtat: [
      { etat: 'Neuf', count: 8, percentage: 40.0 },
      { etat: 'Occasion', count: 5, percentage: 25.0 },
      { etat: 'Réparé', count: 4, percentage: 20.0 },
      { etat: 'En panne', count: 2, percentage: 10.0 },
      { etat: 'Livré', count: 1, percentage: 5.0 }
    ],
    byMarque: [
      { marque: 'Apple', count: 6, percentage: 30.0 },
      { marque: 'Samsung', count: 5, percentage: 25.0 },
      { marque: 'Dell', count: 4, percentage: 20.0 },
      { marque: 'Lenovo', count: 3, percentage: 15.0 },
      { marque: 'Huawei', count: 2, percentage: 10.0 }
    ],
    averageYear: 2021.5,
    recentAdditions: 5,
    deviceTypeDistribution: [
      { type: 'PCs', count: 12, percentage: 60.0 },
      { type: 'Smartphones', count: 8, percentage: 40.0 }
    ]
  });
